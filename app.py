from autocompleter_fake import Autocompleter
...
# Interactive completion selection notifications
@app.route('/autocomplete-selection', methods=['POST'])
def process_selection():
    data = request.json
    print("selection - got: " + json.dumps(data, indent = 4)) # TODO[dvs]: log
...
def process_submission():
    data = request.json
    print("submit - got: " + json.dumps(data, indent = 4)) # TODO[dvs]: log
    return jsonify({'status': 'ok'})
