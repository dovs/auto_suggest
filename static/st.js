        ...
        xn = function (A, e, t) {
            ...
            switch (e) {
                ...
                case Rt.CJK_EARTHLY_BRANCH:
                    return Dn(A, "子丑寅卯辰巳午未申酉戌亥", n);
                case Rt.CJK_HEAVENLY_STEM:
                    return Dn(A, "甲乙丙丁戊己庚辛壬癸", n);
                case Rt.CJK_IDEOGRAPHIC:
                case Rt.TRAD_CHINESE_INFORMAL:
                    return _n(A, "零一二三四五六七八九", "十百千萬", "負", n, 14);
                case Rt.TRAD_CHINESE_FORMAL:
                    return _n(A, "零壹貳參肆伍陸柒捌玖", "拾佰仟萬", "負", n, 15);
                case Rt.SIMP_CHINESE_INFORMAL:
                    return _n(A, "零一二三四五六七八九", "十百千萬", "负", n, 14);
                case Rt.SIMP_CHINESE_FORMAL:
                    return _n(A, "零壹贰叁肆伍陆柒捌玖", "拾佰仟萬", "负", n, 15);
                case Rt.JAPANESE_INFORMAL:
                    return _n(A, "〇一二三四五六七八九", "十百千万", "マイナス", n, 0);
                case Rt.JAPANESE_FORMAL:
                    return _n(A, "零壱弐参四伍六七八九", "拾百千万", "マイナス", n, 7);
                case Rt.KOREAN_HANGUL_FORMAL:
                    return _n(A, "영일이삼사오육칠팔구", "십백천만", "마이너스", s, 7);
                case Rt.KOREAN_HANJA_INFORMAL:
                    return _n(A, "零一二三四五六七八九", "十百千萬", "마이너스", s, 0);
                case Rt.KOREAN_HANJA_FORMAL:
                    return _n(A, "零壹貳參四五六七八九", "拾百千", "마이너스", s, 7);
                case Rt.DEVANAGARI:
                ...
                case Rt.KATAKANA:
                    return Dn(A, "アイウエオカキクケコサシスセソタチツテトナニヌネノハヒフヘホマミムメモヤユヨラリルレロワヰヱヲン", n);
                case Rt.KATAKANA_IROHA:
                    return Dn(A, "イロハニホヘトチリヌルヲワカヨタレソツネナラムウヰノオクヤマケフコエテアサキユメミシヱヒモセス", n);
                case Rt.LAO:
